package com.pimage.searchengine.draft.draft1;

import com.pimage.searchengine.util.Paths;
...
public class LuceneBuildIndex {
    ...
    public static void main( String[] args ) {
        try {
            ...
            String pathCorpus = Paths.ensureParentDirectoryExists(Paths.pathExempleCorpus);
            String pathIndex = Paths.ensureDirectoryExists(Paths.pathIndex1);
            System.out.println("pathCorpus = : " + pathCorpus);
